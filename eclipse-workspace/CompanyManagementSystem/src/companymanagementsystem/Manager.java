...
public class Manager extends Worker {
	...
	public void displayInfo() {
		...
		System.out.println("\n - " + managerName + " with id " + getId() + " is a manager\n" + "   " + managerName
				+ " has basic salary " + getBasicSalary() + ", worked " + getTotalMonthHours(Person.getCURRENT_MONTH())
				+ " hours this month and has " + getVacationDays() + " vacation days left");
	...
	public boolean addTeamMember(Worker worker) {
		...
		if (workerFound != null) {
			System.out.println("\nWorker " + worker.getName() + " is already in the team list " + "and has id = "
					+ worker.getId());
			return false;
		}
